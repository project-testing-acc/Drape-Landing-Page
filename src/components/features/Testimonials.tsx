  ...
  return (
    <div className="flex gap-0.5">
      {Array.from({ length: count }).map((_, i) => (
        <svg key={i} className="w-3.5 h-3.5 text-[#5E6AD2]" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      <div
        ...
        style={{ background: 'rgba(94,106,210,0.04)', filter: 'blur(100px)' }}
      />
          ...
          {testimonials.map((t, i) => (
            <div
              ...
              style={{
                ...
                boxShadow: i === 1
                  ? '0 0 0 1px rgba(94,106,210,0.2), 0 8px 40px rgba(0,0,0,0.4), 0 0 60px rgba(94,106,210,0.08)'
            ...
            >
              ...
              <div className="pt-5 border-t border-white/[0.06] flex items-center gap-3">
                <img
                  ...
                  style={{ border: '1px solid rgba(94,106,210,0.3)' }}
                />
                <div>
